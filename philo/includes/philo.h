...
/*   Updated: 2023/02/08 11:42:37 by rertzer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct	s_phdata
{
	...
	p_thread_mutex_t	mutex_timeover;
	p_thread_mutex_t	*ware;
}	t_phdata;
...
int				ph_run_trial(t_phdata *phdata);
/* philo */
...
/* return */
int				ph_return_error(t_phdata *phdata, char *str);
